  ...
  Future<void> _signOut() async {
    showDialog(context: context, builder: (context) => AlertDialog(
      ...
      actions: [
        ...
        FilledButton(onPressed: () async { await FirebaseAuth.instance.signOut(); if (mounted) {
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Center(child: Column(children: [
                          Container(
                            ...
                            child: ClipOval(child: (userProfile?.photoUrl.isNotEmpty == true)
                                ? Image.network(userProfile!.photoUrl, fit: BoxFit.cover,
            ...
            const SizedBox(height: 8),
                          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Flexible(child: Text(userProfile?.uniAddress ?? 'University Address',
