...
class OwnerReviewsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<Review>>(
      stream: reviewService.getReviewsForOwnerProperties(ownerUid),
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Reviews from students will appear here after they complete their stays',
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  review.reviewerType.toUpperCase(),
                  style: TextStyle(
                    fontSize: 10,
                    color: review.reviewerType == 'student' 
                        ? Colors.blue[700] 
